                        ...
                        <div class="room-wrap d-md-flex">
                            ...
                            <div class="half left-arrow d-flex align-items-center">
                                <div class="text p-4 p-xl-5 text-center">
                                    ...
                                    <p class="mb-0"><span class="price mr-1">${{$room->price}}</span> <span class="per">per night</span>
                                    </p>
                                    ...
                                    <p class="pt-1"><a href="{{route('hotels.rooms.details',$room->id)}}" class="btn-custom px-3 py-2">View Room
